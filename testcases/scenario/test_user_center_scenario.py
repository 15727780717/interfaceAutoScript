...
# @Time    : 2025/5/8 10:42
# @Author  : Cqq
# @File    : test_user_center_scenario.py
# Description: USER_CENTER 模块场景测试
import allure
import pytest
...
@allure.feature("USER CENTER scenario test cases")
class TestUserCenterScenarioCases:
    cases = read_scenario_yaml("USER_CENTER.yaml")
