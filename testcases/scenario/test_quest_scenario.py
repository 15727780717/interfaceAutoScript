...
# @Time    : 2025/5/8 10:26
# @Author  : Cqq
# @File    : test_quest_scenario.py
# Description: QUEST 模块场景测试
import allure
import pytest
...
@allure.feature("QUEST scenario test cases")
class TestQuestScenarioCases:
    cases = read_scenario_yaml("QUEST.yaml")
