...
# @Time    : 2025/5/8 9:56
# @Author  : Cqq
# @File    : test_store_scenario.py
# Description: STORE 模块场景测试
import allure
import pytest
...
@allure.feature("STORE scenario test cases")
class TestStoreScenarioCases:
    cases = read_scenario_yaml("STORE.yaml")
