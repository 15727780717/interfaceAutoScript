...
# @Time    : 2025/5/8 11:00
# @Author  : Cqq
# @File    : test_worldview_scenario.py
# Description: WORLDVIEW 模块场景测试
import allure
import pytest
...
@allure.feature("WORLDVIEW scenario test cases")
class TestWorldViewScenarioCases:
    cases = read_scenario_yaml("WORLDVIEW.yaml")
